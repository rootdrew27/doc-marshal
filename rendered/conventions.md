...
not tell you that the generated index is `INDEX.md` and this file should be deleted or renamed.
...
- **The drift spine** is the set of fields that resolve as `repo-path` -- today `code_refs`.
